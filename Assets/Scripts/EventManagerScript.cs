...
public static class EventManagerScript 
{
    ...
    public static UnityEvent customerReachedOrderingLocationEvent = new UnityEvent();
    //chef
    ...
    public static UnityEvent chefPicksUpBeerEvent = new UnityEvent();
    public static UnityEvent chefPicksUpRedWineEvent = new UnityEvent();
    public static UnityEvent chefPicksUpWhiteWineEvent = new UnityEvent();
    public static UnityEvent chefPicksUpWaterEvent = new UnityEvent();
